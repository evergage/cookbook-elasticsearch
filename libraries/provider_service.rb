...
class ElasticsearchCookbook::ServiceProvider < Chef::Provider::LWRPBase
  ...
  def action_configure
    ...
    #
    create_initd_service(new_resource)

    if es_conf.include_systemd_scripts
      create_systemd_service(new_resource, directory)
    end
  ...
  def create_initd_service(new_resource)
  ...
  def create_systemd_service(new_resource, directory)
